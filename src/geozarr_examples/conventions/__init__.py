...
Example usage:
    ...
    from geozarr_examples.conventions import (
        Spatial,
...
from geozarr_examples.conventions.common import ZarrConventionMetadata
from geozarr_examples.conventions.multiscales import (
...
from geozarr_examples.conventions.proj import (
    PROJ_SCHEMA_URL,
    PROJ_SPEC_URL,
    PROJ_UUID,
    GeoProj,
...
from geozarr_examples.conventions.spatial import (
    SPATIAL_SCHEMA_URL,
    SPATIAL_SPEC_URL,
    SPATIAL_UUID,
    Spatial,
