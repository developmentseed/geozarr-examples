"""
Command-line interface for geozarr-examples.

Usage:
    geozarr-examples validate <path> [--conventions ...]
    geozarr-examples info <path> [--json]
"""
...
def _get_version() -> str:
    ...
    try:
        from geozarr_examples._version import version
...
def validate_command(args: argparse.Namespace) -> int:
    ...
    from geozarr_examples.helpers import detect_conventions, validate_group
...
def info_command(args: argparse.Namespace) -> int:
    ...
    from geozarr_examples.helpers import detect_conventions
